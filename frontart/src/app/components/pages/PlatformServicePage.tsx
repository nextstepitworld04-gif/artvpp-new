    ...
    <div className="min-h-screen bg-[#fcfaf6]">
      ...
      <section className="relative overflow-hidden bg-[#171111]">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-28">
          ...
          <div className="mt-9"><a href="#pricing" className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#a73f2b] to-[#C9A858] px-8 py-4 text-black font-semibold">Explore Pricing <ArrowRight className="w-5 h-5" /></a></div>
